    ...
    return (
        ...
        <div className='grid sm:grid-cols-3 gap-3 mx-10 mt-10 mb-20 font-montserrat'>
            ...
            <div className="max-w-xs rounded-md shadow-md bg-white text-black">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-2">
                        <h2 className="text-3xl text-indigo-800 font-semibold tracking-wide">Add to Cart</h2>
            ...
            <div className="max-w-xs rounded-md shadow-md bg-white text-black">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    <div className="space-y-2">
                        <h2 className="text-3xl text-indigo-800 font-semibold tracking-wide">Checkout Page</h2>
